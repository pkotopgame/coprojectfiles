...
public:
    ...
    LW_RESULT GetObjDummyRunTimeMatrix( lwMatrix44* mat, DWORD obj_id, DWORD dummy_id ) const;
    LW_RESULT GetObjDummyRunTimeMatrix( lwMatrix44* mat, DWORD dummy_id ) const;
    void SetMaterial(const D3DMATERIALX* mtl) const;
    void SetOpacity(float opacity) const;
    void SetTextureLOD(DWORD level) const;

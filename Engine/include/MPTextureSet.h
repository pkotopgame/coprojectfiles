...
public:
	...
	//list of icons to not be released at all 
	std::unordered_set<std::string>PermIcons{
		"texture/icon/q0033.png",
		"texture/icon/n1387.png",
	};
...
inline void SetTextureAsSkillIcon( const std::string& TexName,const bool isPerm=true) {
	if (NewMPTexSet::Instance() != nullptr) {

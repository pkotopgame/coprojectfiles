...
: CCompent(frmOwn), evtSelectChange(NULL), _IsTextCenter(true)
,_nLeftMargin(0),_nTopMargin(4),_nRightMargin(4) ,_nBottomMargin(4),_nRowHeight(20)
, _nMaxNum(40),_nRowNum(0),_bIsHaveItem(false),_bIsHaveMis(false),_nItemRowNum(0)
,_nMisRowNum(0),_nMemoNum(0),_nSelectItem(-1),_nSelectMission(-1)
,_color(0xff000000), _nFirstRow(0) ,_nLastRow(0),_nPageShowNum(4)
{
	int i=0;

...
{
	// ï¿½Þ¸ï¿½ï¿½Ø´ó³¡¾ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ê¾ï¿½Þ³ï¿½bugï¿½ï¿½//by clp
	...
	m_bShowTerrain(true)
{
	...
	//lstrcpy( LogFont.lfFaceName, "ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½" );
...
int CGameScene::HitTestSceneObjTerrainForInfluence(D3DXVECTOR3* t_pos, const D3DXVECTOR3* nPos)
{
	...
	if (s && h.z < fHeight - 0.3f) // ï¿½ï¿½Îªï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Æ´ï¿½ï¿½ï¿½Ê±ï¿½ï¿½Í¨ï¿½ï¿½ï¿½á½«ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ò»ï¿½Î¾ï¿½ï¿½ï¿?
	{
		//h.z = 0;
		s = 0;
	}
...
bool CGameScene::_ClearMemory()
{
	...
	_ClearAllShade();
	_ClearAllEff();	// ï¿½ï¿½Ð§Òªï¿½ï¿½ï¿½ï¿½ï¿?,ï¿½ï¿½Îªï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½,ï¿½ï¿½ï¿?
...
// ï¿½ï¿½ï¿½Ü£ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ë£¨nCurX, nCurYï¿½ï¿½Ð¡ï¿½ï¿½nDistï¿½ï¿½ï¿½×µÄ½ï¿½É«ï¿½ï¿½ï¿½ï¿½ï¿½ëµ½Ñ°ï¿½ï¿½ï¿½ï¿½ï¿½Ï°ï¿½ï¿½ï¿½
long CGameScene::AddCharacterBlock(int nCurX, int nCurY, int nDist, BYTE * byBlockBuff, int nBuffWidth, int sRadii)
{
	...
	int		nCharacterBlockRadius = 40;		//ï¿½ï¿½ï¿½ï¿½
...
bool CGameScene::_HandleSuperKey()
{
	...
	else if (g_pGameApp->IsKeyDown(DIK_F9)) //ï¿½ï¿½ï¿½Ðµï¿½Ç°activeï¿½ï¿½sectionï¿½ï¿½ï¿½ß¶Èºï¿½ï¿½èµ²ï¿½ï¿½ï¿½ã²¢ï¿½ï¿½ï¿½ï¿½
	{
		/*
		// ï¿½Þ¸Ä´Ë´ï¿½Ò»ï¿½ï¿½Òªï¿½Ç³ï¿½Ð¡ï¿½Ä£ï¿½
		// ï¿½ï¿½Î¿ï¿½MPMap::DynamicLoading()ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ã²ï¿½ï¿½ï¿½È·ï¿½ï¿½ï¿½áµ¼ï¿½ï¿½ï¿½ï¿½Òªï¿½ï¿½sectionÃ»ï¿½Ð¶ï¿½ï¿½ï¿½ï¿½Ú´æ£»
		const int	ciSectionWidth = 8;			// ï¿½ï¿½Î»ï¿½ï¿½tileï¿½ï¿½ï¿½×£ï¿½
		const int	ciSectionHeight = 8;		// ï¿½ï¿½Î»ï¿½ï¿½tile
		const int	ciRefreshWidth = 3;			// ï¿½ï¿½ÒªË¢ï¿½Âµï¿½sectionï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Î»ï¿½ï¿½section
		const int	ciRefreshHeight = 3;		// ï¿½ï¿½ÒªË¢ï¿½Âµï¿½sectionï¿½ß£ï¿½ï¿½ï¿½Î»ï¿½ï¿½section
		const int	ciMaxObjWidth = 2;			// ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½È£ï¿½ï¿½ï¿½Î»ï¿½ï¿½section
		const int	ciMaxObjHeight = 2;			// ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ß¶È£ï¿½ï¿½ï¿½Î»ï¿½ï¿½section
		int			iShowSizeX, iShowSizeY;		// ï¿½ï¿½Î»ï¿½ï¿½tile
		int			iShowCenterX, iShowCenterY;	// ï¿½ï¿½Î»ï¿½ï¿½tile
		...
		if (pItem->IsValid()) {
			...
			if (itemData) {
				if (itemData->lID == id) {
					...
					pItem->setIsShowName(!shouldHide);
				}
			}
		}
	}

...
public:
    ...
    void SetFullIconPath(const char* pszText) {
        fullIconPath = pszText;
    }
    //const char* GetIconPath() { return fullIconPath.c_str(); }
    std::string GetIconPath() const { return fullIconPath; }

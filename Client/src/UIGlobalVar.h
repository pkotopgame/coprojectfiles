...
protected:
	static bool Error(const char* strInfo, const char* strFormName, const char* strCompentName);
...
extern CBossRespawnInfo g_stBossRespawnInfo; // boss Respawn info
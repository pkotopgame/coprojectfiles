	...
	if (!m_isInit)
	{
		...
		if (pObj)
		{
...

			{
				...
				{
					{0, 0, 0, ANIM_CTRL_TYPE_BONE, PLAY_ONCE},
					{1, 0, 0, ANIM_CTRL_TYPE_BONE, PLAY_ONCE},
					{2, 0, 0, ANIM_CTRL_TYPE_BONE, PLAY_ONCE},
					{3, 0, 0, ANIM_CTRL_TYPE_BONE, PLAY_ONCE},
					{4, 0, 0, ANIM_CTRL_TYPE_BONE, PLAY_ONCE},
...
bool CSelectChaScene::SelectCharacters(std::span<const NetChaBehave> characters)
{
	...
	for (auto i = 0; i < characters.size(); ++i)
	{
		...
		part.sHairID = chaBehave.look_minimal.hairID;

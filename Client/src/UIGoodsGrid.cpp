...
, evtThrowItem(NULL), evtSwapItem(NULL), evtBeforeAccept(NULL), evtRMouseEvent(NULL)
, evtUseCommand(NULL), _pItems(NULL)
, _eShowStyle(enumSmall), _nUnitHeight(32)
, _nUnitWidth(32), _nSpaceX(2), _nSpaceY(2), _nRow(0)
, _nCol(0), _nMaxNum(0), _nLeftMargin(0), _nTopMargin(0)
, _nRightMargin(0), _nBottomMargin(0), _nFirst(0), _nLast(0), _nCurNum(0)
, _IsShowHint(true), _nTmpIndex(0)
{

...
-- -- function CustomMission001()
	-- -- DefineMission( 817, "Random Power Ring Quest",  817) 
	-- -- MisBeginTalk("<t>Do you want to obtain the <rRandom Power Ring Chest>?!")
	
	-- -- MisBeginCondition(HasRecord, 1)
	-- -- MisBeginCondition(NoRecord, 817)
	-- -- MisBeginCondition(NoMission, 817)
	-- -- MisBeginAction(AddMission, 817)
	-- -- MisBeginAction(AddTrigger, 8171, TE_KILL, 679, 5 )
	-- -- MisBeginAction(AddTrigger, 8172, TE_KILL, 678, 5 )
	-- -- MisBeginAction(AddTrigger, 8173, TE_KILL, 805, 5 )
	-- -- MisBeginAction(AddTrigger, 8174, TE_KILL, 1113, 5 )
	-- -- MisBeginAction(AddTrigger, 8175, TE_GETITEM, 9618, 5 )
	-- -- MisBeginAction(AddTrigger, 8176, TE_GETITEM, 9979, 5 )
	-- -- MisCancelAction(ClearMission, 817)

	-- -- MisResultTalk("<t>Congratulations! You have completed the quest!")
	-- -- MisHelpTalk("Welcome back! Are you done already?")
	-- -- MisNeed(MIS_NEED_DESP, "Bring me <rx5 Ring Scroll and x5 King of Icicle >. Also, you will need to kill 5x of each boss; <rWandering Soul, Snowman Warlord, Barbosa, and Vicious Relic Protector!")
	
	-- -- MisNeed(MIS_NEED_KILL, 679, 5, 10, 5)
	-- -- MisNeed(MIS_NEED_KILL, 678, 5, 20, 5)
	-- -- MisNeed(MIS_NEED_KILL, 805, 5, 30, 5)
	-- -- MisNeed(MIS_NEED_KILL, 1113, 5, 40, 5)
	-- -- MisNeed(MIS_NEED_ITEM, 9618, 5, 50, 5)
	-- -- MisNeed(MIS_NEED_ITEM, 9979, 5, 60, 5)

	-- -- MisResultCondition(HasMission, 817)
	-- -- MisResultCondition(HasFlag, 817, 11 )
	-- -- MisResultCondition(HasFlag, 817, 21 )
	-- -- MisResultCondition(HasFlag, 817, 31 )
	-- -- MisResultCondition(HasFlag, 817, 41 )
	-- -- MisResultCondition(HasItem, 9618, 5 )
	-- -- MisResultCondition(HasItem, 9979, 5 )
	
	-- -- MisResultAction(TakeItem, 9618, 5 )
	-- -- MisResultAction(TakeItem, 9979, 5 )
	-- -- MisResultAction(ClearMission, 817)
	-- -- MisResultAction(GiveItem, 9962, 1, 4)

	-- -- InitTrigger()
	-- -- TriggerCondition( 1, IsMonster, 679)
	-- -- TriggerAction( 1, AddNextFlag, 817, 10, 5)
	-- -- RegCurTrigger(8171)

	-- -- InitTrigger()
	-- -- TriggerCondition( 1, IsMonster, 678)
	-- -- TriggerAction( 1, AddNextFlag, 817, 20, 5)
	-- -- RegCurTrigger(8172)

	-- -- InitTrigger()
	-- -- TriggerCondition( 1, IsMonster, 805)
	-- -- TriggerAction( 1, AddNextFlag, 817, 30, 5)
	-- -- RegCurTrigger(8173)

	-- -- InitTrigger()
	-- -- TriggerCondition( 1, IsMonster, 1113)
	-- -- TriggerAction( 1, AddNextFlag, 817, 40, 5)
	-- -- RegCurTrigger(8174)

	-- -- InitTrigger()
	-- -- TriggerCondition( 1, IsItem, 9618)
	-- -- TriggerAction( 1, AddNextFlag, 817, 50, 5)
	-- -- RegCurTrigger(8175)
	
	-- -- InitTrigger()
	-- -- TriggerCondition( 1, IsItem, 9979)
	-- -- TriggerAction( 1, AddNextFlag, 817, 60, 5)
	-- -- RegCurTrigger(8176)
	-- --------Lion's Necklace
	-- -- DefineMission( 837, "Lion's Necklace",  837) 
	-- -- MisBeginTalk("<t>Do you want to obtain the <rLion's Necklace?!")
	
	-- -- MisBeginCondition(HasRecord, 1)
	-- -- MisBeginCondition(NoRecord, 837)
	-- -- MisBeginCondition(NoMission, 837)
	-- -- MisBeginAction(AddMission, 837)
	-- -- MisBeginAction(AddTrigger, 8371, TE_KILL, 789, 5 )
	-- -- MisBeginAction(AddTrigger, 8372, TE_KILL, 1117, 5 )
	-- -- MisBeginAction(AddTrigger, 8373, TE_KILL, 1109, 5 )
	-- -- MisBeginAction(AddTrigger, 8374, TE_KILL, 988, 5 )
	-- -- MisBeginAction(AddTrigger, 8375, TE_GETITEM, 9617, 5 )
	-- -- MisBeginAction(AddTrigger, 8376, TE_GETITEM, 9978, 5 )
	-- -- MisBeginAction(AddTrigger, 8377, TE_GETITEM, 9980, 5 )
	-- -- MisCancelAction(ClearMission, 837)

	-- -- MisResultTalk("<t>Congratulations! You have completed the quest!")
	-- -- MisHelpTalk("Welcome back! Are you done already?")
	-- -- MisNeed(MIS_NEED_DESP, "Bring me <rx5 Pirate Scroll, x5 King of Argent and x5 Glacier Emblem >. Also, you will need to kill 5x of each boss; <rBlack Dragon, Morpheus Abyss Demon, Fury Kara, and Abyss Supreme!")
	
	-- -- MisNeed(MIS_NEED_KILL, 789, 5, 10, 5)
	-- -- MisNeed(MIS_NEED_KILL, 1117, 5, 20, 5)
	-- -- MisNeed(MIS_NEED_KILL, 1109, 5, 30, 5)
	-- -- MisNeed(MIS_NEED_KILL, 988, 5, 40, 5)
	-- -- MisNeed(MIS_NEED_ITEM, 9617, 5, 50, 5)
	-- -- MisNeed(MIS_NEED_ITEM, 9978, 5, 60, 5)
	-- -- MisNeed(MIS_NEED_ITEM, 9980, 5, 70, 5)

	-- -- MisResultCondition(HasMission, 837)
	-- -- MisResultCondition(HasFlag, 837, 11 )
	-- -- MisResultCondition(HasFlag, 837, 21 )
	-- -- MisResultCondition(HasFlag, 837, 31 )
	-- -- MisResultCondition(HasFlag, 837, 41 )
	-- -- MisResultCondition(HasItem, 9617, 5 )
	-- -- MisResultCondition(HasItem, 9978, 5 )
	-- -- MisResultCondition(HasItem, 9980, 5 )
	
	-- -- MisResultAction(TakeItem, 9617, 5 )
	-- -- MisResultAction(TakeItem, 9978, 5 )
	-- -- MisResultAction(TakeItem, 9980, 5 )
	-- -- MisResultAction(ClearMission, 837)
	-- -- MisResultAction(GiveItem, 9952, 1, 4)
	...
	-- -- TriggerAction( 1, AddNextFlag, 837, 20, 5)
	-- -- RegCurTrigger(8372)

	-- -- InitTrigger()
	-- -- TriggerCondition( 1, IsMonster, 1109)
	-- -- TriggerAction( 1, AddNextFlag, 837, 30, 5)
	-- -- RegCurTrigger(8373)

	-- -- InitTrigger()
	-- -- TriggerCondition( 1, IsMonster, 988)
	-- -- TriggerAction( 1, AddNextFlag, 837, 40, 5)
	-- -- RegCurTrigger(8374)

	-- -- InitTrigger()
	-- -- TriggerCondition( 1, IsItem, 9617)
	-- -- TriggerAction( 1, AddNextFlag, 837, 50, 5)
	-- -- RegCurTrigger(8375)
	
	-- -- InitTrigger()
	-- -- TriggerCondition( 1, IsItem, 9978)
	-- -- TriggerAction( 1, AddNextFlag, 837, 60, 5)
	-- -- RegCurTrigger(8376)
	
	-- -- InitTrigger()
	-- -- TriggerCondition( 1, IsItem, 9980)
	-- -- TriggerAction( 1, AddNextFlag, 837, 70, 5)
	-- -- RegCurTrigger(8377)
	-- -- ---Level 85 Weapons Ice-covered
	-- -- DefineMission( 838, "Level 85 Weapon Voucher",  838) 
	-- -- MisBeginTalk("<t>Do you want to obtain the <Level 85 Weapon Voucher!")
	
	-- -- MisBeginCondition(HasRecord, 1)
	-- -- MisBeginCondition(NoRecord, 838)
	-- -- MisBeginCondition(NoMission, 838)
	-- -- MisBeginAction(AddMission, 838)
	-- -- MisBeginAction(AddTrigger, 8381, TE_KILL, 979, 5 )
	-- -- MisBeginAction(AddTrigger, 8382, TE_KILL, 980, 5 )
	-- -- MisBeginAction(AddTrigger, 8383, TE_KILL, 981, 5 )
	-- -- MisBeginAction(AddTrigger, 8384, TE_KILL, 982, 5 )
	-- -- MisBeginAction(AddTrigger, 8385, TE_KILL, 789, 5 )
	-- -- MisBeginAction(AddTrigger, 8386, TE_KILL, 987, 3 )
	-- -- -- MisBeginAction(AddTrigger, 8387, TE_GETITEM, 9989, 7 )
	-- -- -- MisBeginAction(AddTrigger, 8388, TE_GETITEM, 10005, 2 )
	
	-- -- MisCancelAction(ClearMission, 838)

	-- -- MisResultTalk("<t>Congratulations! You have completed the quest!")
	-- -- MisHelpTalk("Welcome back! Are you done already?")
	-- -- MisNeed(MIS_NEED_DESP, "You need to kill 5x of each boss; <rAbyss Lord - Phantom Baron, Abyss Lord - Demon Flame, Abyss Lord - Evil Beast, Abyss Lord - Tyran, Black Dragon and Abyss Lord - Hardin Black Death !>")
	
	-- -- MisNeed(MIS_NEED_KILL, 979, 5, 10, 5)
	-- -- MisNeed(MIS_NEED_KILL, 980, 5, 20, 5)
	-- -- MisNeed(MIS_NEED_KILL, 981, 5, 30, 5)
	-- -- MisNeed(MIS_NEED_KILL, 982, 5, 40, 5)
	-- -- MisNeed(MIS_NEED_KILL, 789, 5, 50, 5)
	-- -- MisNeed(MIS_NEED_KILL, 987, 3, 60, 3)
	-- -- -- MisNeed(MIS_NEED_ITEM, 9989, 7, 70, 7)
	-- -- -- MisNeed(MIS_NEED_ITEM, 10005, 2, 80, 2)
	
	-- -- MisResultCondition(HasMission, 838)
	-- -- MisResultCondition(HasFlag, 838, 11 )
	-- -- MisResultCondition(HasFlag, 838, 21 )
	-- -- MisResultCondition(HasFlag, 838, 31 )
	-- -- MisResultCondition(HasFlag, 838, 41 )
	-- -- MisResultCondition(HasFlag, 838, 51 )
	-- -- MisResultCondition(HasFlag, 838, 61 )
	-- -- -- MisResultCondition(HasItem, 9989, 7 )
	-- -- -- MisResultCondition(HasItem, 10005, 2 )
	
	-- -- -- MisResultAction(TakeItem, 9989, 7 )
	-- -- -- MisResultAction(TakeItem, 10005, 2 )
	
	-- -- MisResultAction(ClearMission, 838)
	-- -- MisResultAction(GiveItem, 32324, 1, 4)

	-- -- InitTrigger()
	-- -- TriggerCondition( 1, IsMonster, 979)
	-- -- TriggerAction( 1, AddNextFlag, 838, 10, 5)
	-- -- RegCurTrigger(8381)

	-- -- InitTrigger()
	-- -- TriggerCondition( 1, IsMonster, 980)
	-- -- TriggerAction( 1, AddNextFlag, 838, 20, 5)
	-- -- RegCurTrigger(8382)

	-- -- InitTrigger()
	-- -- TriggerCondition( 1, IsMonster, 981)
	-- -- TriggerAction( 1, AddNextFlag, 838, 30, 5)
	-- -- RegCurTrigger(8383)

	-- -- InitTrigger()
	-- -- TriggerCondition( 1, IsMonster, 982)
	-- -- TriggerAction( 1, AddNextFlag, 838, 40, 5)
	-- -- RegCurTrigger(8384)

	-- -- InitTrigger()
	-- -- TriggerCondition( 1, IsMonster, 789)
	-- -- TriggerAction( 1, AddNextFlag, 838, 50, 5)
	-- -- RegCurTrigger(8385)

	-- -- InitTrigger()
	-- -- TriggerCondition( 1, IsMonster, 987)
	-- -- TriggerAction( 1, AddNextFlag, 838, 60, 3)
	-- -- RegCurTrigger(8386)
	
	-- -- InitTrigger()
	-- -- TriggerCondition( 1, IsItem, 9989)
	-- -- TriggerAction( 1, AddNextFlag, 838, 70, 7)
	-- -- RegCurTrigger(8387)
	
	-- -- InitTrigger()
	-- -- TriggerCondition( 1, IsItem, 10005)
	-- -- TriggerAction( 1, AddNextFlag, 838, 80, 2)
	-- -- RegCurTrigger(8388)

...
function leo_talkbb()
	Talk(1, "Selling PK Potions! Do not come if you have Goods to Trade!!")
	Text(1, "Exchange Goods.", SendExchangeXData)

	
	--兑换所需物品 ID,数量,兑换所得物品数量,赋予的值
	InitExchangeX()

	ExchangeDataX(4546	,	99	,	9959	,	20	,	1)
	ExchangeDataX(4543	,	99	,	9959	,	20	,	1)
	ExchangeDataX(1478	,	99	,	9959	,	20	,	1)
...
function JackpotMachine()
	...
	Text(1, "Try your luck, play a round!", OpenTiger)
	Talk(2, "Jackpot Machine: Each try requires 5 Diamond Lottery. You can try multiple times. The more you try, the higher your chance of winning!")
end
function r_talk255()
...
function r_talk76x ()
	...
	TriggerFailure( 2, JumpPage, 3 )
	Text( 1, "Heal", MultiTrigger,GetMultiTrigger(),2)
	Text( 1, "Record Spawn", SetSpawnPos, "Maze Portal")
	Talk( 2, "Anne: Sorry, Healing requires 200G. You do not have enough?-" )
	Talk( 3, "Anne: Sorry! Healing requires 50G?-You do not have enough?-" )
end 
...
public:
	...
	void	Drop();
	static void	ExecTimeCha(SMgrUnit *pChaInfo);
...
public:
	...
	CItem*		ItemSpawn(const SItemGrid *pItemInfo, dbc::Long lPosX, dbc::Long lPosY, dbc::Char chSpawnType,
		...
		CEvent	*pCEvent = NULL);
	CCharacter* ChaSpawn(Long lChaInfoID, Char chCtrlType, Short sAngle, const Point* pSPos, bool bEyeshotAbility = false,
		cChar* cszChaName = nullptr, long clSearchRadius = 120 * 100, long lReliveTime = 10000);
...
//	dbc::Long	m_lActivePlayerNum;
	...
	// bosses respawn tracker pending ticks @mothannakh
	CTimer m_BossesPendingRespawn{};
};

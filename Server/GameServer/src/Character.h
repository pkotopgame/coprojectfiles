...
public:
	...
	void		Cmd_ItemLotteryAsk(const SLotteryItem *pSItem);
	...
	void		Cmd_LifeSkillItemAsR(long dwType, const SLifeSkillItem *pSItem);
    //��������
    void        Cmd_LockKitbag();
...
public:
	void ResetLifeTime(const DWORD dwTime, const bool canRespawn = false) {
		_dwLifeTime = dwTime;
		canRespawnMonsterLifeTime = canRespawn;
	...
	bool canRespawnMonsterLifeTime{ false };//this if can respawn monster with it had life time option
	DWORD	_dwStallTick;

...
public:
	...
	void post_mapcrash_msg(const ClientConnection* ply);
	...
	dbc::WPacket CM_LOGOUT(dbc::DataSocket* datasock, const dbc::RPacket& recvbuf);
	void CM_BGNPLAY(dbc::DataSocket* datasock, const dbc::RPacket& recvbuf);
	void CM_ENDPLAY(dbc::DataSocket* datasock, const dbc::RPacket& recvbuf);
	void CM_NEWCHA(dbc::DataSocket* datasock, const dbc::RPacket& recvbuf);
	void CM_REGISTER(dbc::DataSocket* datasock, const dbc::RPacket& recvbuf);
	void CP_CHANGEPASS(dbc::DataSocket* datasock, const dbc::RPacket& recvbuf);
	void CM_DELCHA(dbc::DataSocket* datasock, const dbc::RPacket& recvbuf);
	void CM_CREATE_PASSWORD2(dbc::DataSocket* datasock, dbc::RPacket& recvbuf);
	void CM_UPDATE_PASSWORD2(dbc::DataSocket* datasock, const dbc::RPacket& recvbuf);
...
private:
	static bool		 DoCommand(dbc::DataSocket* datasock, dbc::cChar* cmdline);
